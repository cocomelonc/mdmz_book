39. kötü amaçlı yazılım geliştirme hileleri. Mutex. C++ örneği.
﷽


+++++++++++++++++++++++++++++++++++++++++++++

Bu yazı, kötü amaçlı yazılım geliştirme hilesi olan: mutex kullanarak kendini çalıştırmayı engelleme konusundaki kendi araştırmamın sonucudur.  

Bazen, kötü amaçlı yazılım geliştirirken, maksimum gizlilik için programın yalnızca bir kez çalıştırılmasını sağlamak gerekir. Bunu yapmak için, MSDN belgelerine göre, mutex'ler kullanılabilir.  

mutex  
Basitlik adına, Windows API'sinden CreateMutexA işlevini kullanabiliriz:
...
En basit uygulamada, bu işlevi şu şekilde kullanabilirsiniz:  

Özel bir isimle mutex oluşturun, böylece birden fazla örnek bunu tespit edebilir:

hMutex = CreateMutexA(NULL, FALSE, "MeowMeowMutex");

Mutex'in zaten var olup olmadığını kontrol edin, varsa uygulamadan çıkın:
...
Aksi takdirde, kötü amaçlı mantığı çalıştırın ve işlem tamamlandığında mutex'i kapatın:
...
Yani, tam kaynak kodu şu şekilde görünecek:
...
Gördüğünüz gibi, EnumChildWindows mantığı aracılığıyla çalışan shellcode kullanıyorum. Ayrıca, her zamanki gibi meow-meow messagebox payload'unu kullanıyorum.  

Demo  
Hadi her şeyi aksiyon halinde görelim. "Kötü amaçlı yazılımımızı" derleyelim:
...
+++++++++++++++++++++++++++++++++++++++++++++
Ardından, hedef makineye (benim durumumda Windows 10 x64) geçin ve çalıştırın:

.\hack.exe

+++++++++++++++++++++++++++++++++++++++++++++
Ardından, bu "kötü amaçlı yazılımı" başka bir PowerShell terminalinden tekrar çalıştırmayı deneyin:

+++++++++++++++++++++++++++++++++++++++++++++
Gördüğünüz gibi, hiçbir şey başlamadı, sadece bir messagebox'ımız var.  
Doğruluğu kontrol etmek için, kodumuza bazı yazdırma işlemleri ekleyebiliriz:
...
Ardından, adımlarımızı tekrar edelim:
...
+++++++++++++++++++++++++++++++++++++++++++++
Böylece, 62 antivirüs motorunun 17'si dosyamızı kötü amaçlı olarak tespit ediyor.

https://www.virustotal.com/gui/file/153d249063f46b0d56603d7aab7e43a3361d74
e9852367d8730f5e57fb9f5b9f/details

Bu hile, örneğin Conti ransomware, Hellokitty ransomware ve AsyncRAT tarafından gerçek dünyada kullanılıyor.  
...
Github’taki kaynak kod: https://github.com/cocomelonc/meow/tree/master/2023-01-04-malware-tricks-26

40. kötü amaçlı yazılım geliştirme hilesi. WinAPI LoadLibrary uygulaması. Basit C++ örneği.
﷽

+++++++++++++++++++++++++++++

Bugün, araştırmamı başka bir kötü amaçlı yazılım geliştirme hilesine odaklamak istiyorum: bu, bazı durumlar ve senaryolarda antivirüs (AV) kaçışına da yardımcı olabilir. Daha önceki GetModuleHandle ve GetProcAddress uygulamalarıyla ilgili yazılarda olduğu gibi, kendi LoadLibrary uygulamamı yapalım mı? Hadi bunu deneyelim.  
...
Peki, MyLoadLibrary ile DLL'imizi diğer uygulamalarda kullanabilir miyiz?  
Evet, kullanabiliriz. Ayrıca, gördüğünüz gibi, GetProcAddress ile işlev adreslerini alabiliriz.  
...
41.kötü amaçlı yazılım geliştirme hilesi. lsass.exe dökümü. Basit C++ örneği.
﷽

+++++++++++++++++++++++++++++

Bugün, Mimikatz kullanmadan nasıl lsass.exe dökümü alabileceğimizi göstermek istiyorum: MiniDumpWriteDump API'si aracılığıyla. Mimikatz çok ünlü bir araç olduğu için kolayca tespit edilebiliyor, bu nedenle siber saldırganlar, onun bazı özelliklerini yeniden uygulamak için yeni hileler buluyorlar.  
...
• hed efmakinesinin şifrelerini saldırganın makinesinde dökün!  
Bu sadece bir yöntem, gelecekte başka yöntemler hakkında da bahsedeceğim.  

Bu hile, birçok APT ve siber saldırı aracında kullanılmaktadır. Örneğin, Cobalt Strike, LSASS belleğine enjekte etmek ve şifre hash'lerini dökmek için bir iş başlatabilir. Fox Kitten ve HAFNIUM, LSASS işlem belleğini dökmek için procdump kullandı.  
