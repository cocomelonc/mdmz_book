...
Së pari, do të shqyrtojmë një koncept të tillë si reverse shell, pasi kjo është shumë e rëndësishme në zhvillimin e malware-it.

### Çfarë është reverse shell?

Reverse shell ose shpesh i quajtur  "connect-back shell" është një shell në distancë që krijohet nga  objektivi duke u lidhur përsëri me makinën e sulmuesit dhe duke krijuar një shell të objektivit në makinën e sulmuesit. Kjo zakonisht përdoret gjatë procesit të shfrytëzimit (exploitation) për të fituar kontroll mbi një  makinë në distancë.
